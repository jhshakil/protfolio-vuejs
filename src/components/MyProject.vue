        ...
        <div class="grid grid-cols-2 gap-12 mt-16 items-center">
            ...
            <div>
                ...
                <div class="flex justify-evenly items-center my-4">
                    <div class="bg-gray-300 text-black p-2 rounded-md w-1/4 text-xl text-center">Live site</div>
                    <div class="bg-gray-300 text-black p-2 rounded-md w-1/4 text-xl text-center">Details</div>
                </div>
            </div>
        </div>
        <div class="grid grid-cols-2 gap-12 mt-16 items-center">
            <img src="../assets/project2/project2.jpg" class="rounded-lg order-2" alt="Project 1">
            <div class="order-1">
